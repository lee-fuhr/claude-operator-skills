...
Use AskUserQuestion with multiple choice ONLY for genuine gaps. For example, if you truly can't tell what test runner is in use, ask. If you can infer it, state the inference.
