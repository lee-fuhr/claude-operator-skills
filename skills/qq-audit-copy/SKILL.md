...
Use AskUserQuestion with multiple choice ONLY for genuine gaps. For example, if you truly can't tell whether this is a consumer app or B2B enterprise tool, ask. If you can infer it, state the inference.
