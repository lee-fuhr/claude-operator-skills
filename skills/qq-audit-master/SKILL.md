...
|---------|---------|-------------|
| **quick** | UX, Visual, Copy | Fast quality check on appearance and usability |
...
- **Code + screenshots/browser:** Both. Most thorough, since code reveals WHY and screenshots reveal WHAT the user actually sees.
...
4. Any specific concerns? (from conversation, e.g. "the forms feel broken", "worried about mobile")
