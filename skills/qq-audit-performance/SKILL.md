...
> - **Known pain points:** [what the user has mentioned, such as slow pages, large bundles, API latency]
> - **Scope:** [full app / specific routes / specific infrastructure layer]
>
> Anything wrong or missing?"

Use AskUserQuestion with multiple choice ONLY for genuine gaps. For example, if you truly can't tell whether it's SSR or SPA, ask. If you can infer it, state the inference.
