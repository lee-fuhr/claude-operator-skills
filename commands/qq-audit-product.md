Run the Product audit skill. Load the skill file at `~/.agents/skills/qq-audit-product/SKILL.md` and follow its instructions.

Args passed: $ARGUMENTS

If no args: run full serial audit (all 20 frameworks).
