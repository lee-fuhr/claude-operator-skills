Run the Frontend Build Quality audit skill. Load the skill file at `~/.agents/skills/qq-audit-frontend/SKILL.md` and follow its instructions.

Args passed: $ARGUMENTS

If no args: run full serial audit (all 22 frameworks).
