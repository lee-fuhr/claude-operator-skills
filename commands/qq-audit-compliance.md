Run the Compliance audit skill. Load the skill file at `~/.agents/skills/qq-audit-compliance/SKILL.md` and follow its instructions.

Args passed: $ARGUMENTS

If no args: run full serial audit (all 15 frameworks).
