...
Load the skill file at `~/.claude/skills/qq-weekend-burn/SKILL.md` and follow its instructions. It in turn depends on `~/.claude/skills/ww-keepalive/SKILL.md` for the actual session-survival mechanism; load that too if it isn't already in context.
